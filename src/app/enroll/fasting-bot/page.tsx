...
export default function EnrollFastingBotPage() {
  ...
  async function enroll() {
    ...
    const res = await fetch("/api/enroll", {
      ...
      body: JSON.stringify({ gameType: "FASTING_BOT" }),
    });
  ...
  return (
    <main style={{ padding: 12 }}>
      ...
      <div style={{ fontSize: 12, opacity: 0.75, marginBottom: 12 }}>
        Same Fastings rules on ~2 minute phases. Lobby waits 15 minutes for players, then bots fill empty seats. Practice — no payouts.
      </div>
