...
export default async function ProfilePage({ searchParams }: { searchParams: { page?: string } }) {
  ...
  const friends = friendRows.map((f) => ({
    ...
    avatar: {
      ...
      glassesStyle: oneOf(f.friend.glassesStyle, ["none"], "none"),
      scarStyle: oneOf(f.friend.scarStyle, ["none"], "none"),
      hairOrnamentStyle: oneOf(f.friend.hairOrnamentStyle, ["none"], "none"),
      ...
      backgroundColor: f.friend.backgroundColor ?? "#E8E8E8",
      glassesColor: f.friend.glassesColor ?? "#111111",
      scarColor: f.friend.scarColor ?? "#8B4513",
      hairOrnamentColor: f.friend.hairOrnamentColor ?? "#C0C0C0",
    },
  }));
  ...
  const avatar: AvatarConfig = {
    ...
    glassesStyle: oneOf(user.glassesStyle, ["none"], "none"),
    scarStyle: oneOf(user.scarStyle, ["none"], "none"),
    hairOrnamentStyle: oneOf(user.hairOrnamentStyle, ["none"], "none"),
